  ...
  return (
    <footer className="glass-effect border-t border-border/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Divider */}
          <div className="border-t-2 border-primary/60 py-6">
          {/* Thank You Message */}
          ...
          {/* Footer Bottom */}
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-muted-foreground pt-6 border-t-2 border-primary/60">
          ...
          {/* Legal Name Note */}
            <p className="text-xs text-muted-foreground/70 text-center pt-4 border-t-2 border-primary/60 mt-4">
